 ...
 *
 */
package com.allthatsfashion.test.setup;
...
import com.allthatsfashion.test.constants.AllthatsfashionTestConstants;
import com.allthatsfashion.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = AllthatsfashionTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/allthatsfashiontest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/allthatsfashiontest/import/reviews.impex");
			...
			importImpexFile(context, "/allthatsfashiontest/import/cstickets.impex");
		}
	}
}

 ...
 *
 */
package com.allthatsfashion.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, AllthatsfashionFulfilmentProcessConstants.PARENT_PROCESS);

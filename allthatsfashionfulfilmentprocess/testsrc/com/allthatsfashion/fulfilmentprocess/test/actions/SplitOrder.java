 ...
 *
 */
package com.allthatsfashion.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(AllthatsfashionFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AllthatsfashionFulfilmentProcessConstants.PARENT_PROCESS);

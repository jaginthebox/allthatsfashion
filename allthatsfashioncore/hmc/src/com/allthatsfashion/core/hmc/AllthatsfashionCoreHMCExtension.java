 ...
 *
 */
package com.allthatsfashion.core.hmc;
...
/**
 * Provides necessary meta information about the allthatsfashioncore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class AllthatsfashionCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(AllthatsfashionCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.allthatsfashion.core.hmc.locales";

 ...
 *
 */
package com.allthatsfashion.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("allthatsfashioncockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("allthatsfashioncockpits.product.externalTaxes"));

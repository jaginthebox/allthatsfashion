 ...
 *
 */
package com.allthatsfashion.cockpits.setup;
...
import com.allthatsfashion.cockpits.constants.AllthatsfashionCockpitsConstants;
 ...
 */
@SystemSetup(extension = AllthatsfashionCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(AllthatsfashionCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(AllthatsfashionCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						AllthatsfashionCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/allthatsfashioncockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
